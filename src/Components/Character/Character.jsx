...
const types = [
    {
        key: "Разрушение",
        icon: "https://i.imgur.com/bLKWzBM.png",
        alt: "destruction icon",
    },
    { key: "Охота", icon: "https://i.imgur.com/r0m2RaE.png", alt: "hunt icon" },
    {
        key: "Эрудиция",
        icon: "https://i.imgur.com/79saAod.png",
        alt: "erudition icon",
    },
    {
        key: "Гармония",
        icon: "https://i.imgur.com/sPHDW4p.png",
        alt: "harmony icon",
    },
    {
        key: "Небытие",
        icon: "https://i.imgur.com/BNzXos9.png",
        alt: "nihility icon",
    },
    {
        key: "Сохранение",
        icon: "https://i.imgur.com/sO1OQH6.png",
        alt: "preservation icon",
    },
    {
        key: "Изобилие",
        icon: "https://i.imgur.com/oj8rDBc.png",
        alt: "abundance icon",
    },
    {
        key: "Память",
        icon: "https://i.imgur.com/nvWuY0t.png",
...
const typesOfFight = [
    {
        key: "Физический",
        icon: "https://i.imgur.com/wSMaqBn.png",
        alt: "physical type",
    },
    {
        key: "Огненный",
        icon: "https://i.imgur.com/PsWUmrn.png",
        alt: "fire type",
    },
    {
        key: "Ледяной",
        icon: "https://i.imgur.com/ko9X2gT.png",
        alt: "ice type",
    },
    {
        key: "Электрический",
        icon: "https://i.imgur.com/1TdnQkN.png",
        alt: "lightning type",
    },
    {
        key: "Ветряной",
        icon: "https://i.imgur.com/KVWVPlF.png",
        alt: "wind type",
    },
    {
        key: "Квантовый",
        icon: "https://i.imgur.com/VfgDZf2.png",
        alt: "quantum type",
    },
    {
        key: "Мнимый",
        icon: "https://i.imgur.com/vrCCYin.png",
        alt: "imaginary type",
    },
];
